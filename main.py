...
# try:
#     # Attempt to append 10 to the tuple (will raise an error)
#     numbers_tuple.append(10)
# except AttributeError:
#     print("Tuples are immutable and cannot be modified.")
# try:
#     # Attempt to insert 20 at index 2 in the tuple (will raise an error)
#     numbers_tuple.insert(2, 20)
# except AttributeError:
#     pass  # Insert operation will also raise an error
# try:
#     # Attempt to remove one element from the tuple (will raise an error)
...
# set_intersection = numbers_set.intersection({5, 8, 11})
# set_difference = numbers_set.difference({3, 7, 11})
#
...
try:
    ...
    pass  # Tuples are immutable and cannot be modified.
...
with open(output_filename, "w") as file:
    ...
    file.write("List to Tuple: " + str(tuple(numbers_list)) + "\n")
    file.write("List to Set: " + str(set(numbers_list)) + "\n")
    file.write("List to Dictionary: " + str({num: num ** 2 for num in numbers_list}) + "\n")
    file.write("Tuple to List: " + str(list(numbers_tuple)) + "\n")
    file.write("Tuple to Set: " + str(set(numbers_tuple)) + "\n")
    file.write("Tuple to Dictionary: " + str({num: num ** 2 for num in numbers_tuple}) + "\n")
    file.write("Set to List: " + str(list(numbers_set)) + "\n")
    file.write("Set to Tuple: " + str(tuple(numbers_set)) + "\n")
    file.write("Set to Dictionary: " + str({num: num ** 2 for num in numbers_set}) + "\n")
    file.write("Dictionary to List: " + str(list(numbers_dict.keys())) + "\n")
    file.write("Dictionary to Tuple: " + str(tuple(numbers_dict.keys())) + "\n")
    file.write("Dictionary to Set: " + str(set(numbers_dict.keys())) + "\n")

# Perform Operations on File
with open(output_filename, "r") as file:
    file_content = file.read()
    line_count = file_content.count('\n')
    integer_count = sum(char.isdigit() for char in file_content)
    integers = [int(s) for s in file_content.split() if s.isdigit()]
...
with open('prime_numbers.txt', 'w') as file:
    ...
    file.write("Is Largest Integer Prime?: " + ("Yes" if largest_prime_check else "No") + '\n')
...
print("Is Largest Integer Prime?:", "Yes" if largest_prime_check else "No")
