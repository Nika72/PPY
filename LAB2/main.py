...
with open('output_file.txt', 'r') as file:
    ...
    # c.
    if "Modified List" in content:
        print("Modified List found in file.")
    else:
        print("Modified List not found in file.")


with open('output_file.txt', 'a') as file:
    # d. Append new lines
    file.write("\nAdditional information: This line is added to the file.")

    # e.
    content = content.replace("Modified List", "New Modified List", 1)
...
print("Number of words in the modified content:", len(words))

# h.
print("Number of characters in the modified content:", len(modified_content))

# i.
word_to_count = 'List'
word_count = modified_content.count(word_to_count)
print("Number of occurrences of '{}' in the modified content: {}".format(word_to_count, word_count))

# j. Perform Operations on File: Open the file, read its content, and perform some operations like counting the number of lines, finding specific data, etc.
